                        ...
                        <div class="col-md-10 m-auto">
                            ...
                            @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Enter subject name" required>
                                        @if ($errors->has('name'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" name="code" id="code" value="{{ old('code') }}" placeholder="Enter subject code" required>
                                        @if ($errors->has('code'))
                                        ...
                                        <div class="col-md-11">
                                            <select class="form-control" id="department" name="department_name" required>
                                                ...
                                                @foreach($departments as $department)
                                                    <option value="{{ $department->id }}" @if( old('department_name') == $department->id) selected @endif>{{ $department->department_name }} ({{ $department->short_name }})</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-11">
                                            <select class="form-control" id="credit" name="credit_number" required>
                                                ...
                                                @foreach($credits as $credit)
                                                    <option value="{{ $credit->id }}" @if( old('credit_number') == $credit->id) selected @endif>{{ number_format((float)$credit->credit_number, 2, '.', '') }}</option>
                                                @endforeach
                                            </select>
