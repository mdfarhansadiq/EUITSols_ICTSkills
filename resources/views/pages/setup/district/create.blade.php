                        ...
                        <div class="col-md-10 m-auto">
                            ...
                            @csrf
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" id="division_name" name="division_name" required>
                                            ...
                                            @foreach ($divisions as $division)
                                                <option value="{{ $division->id }}" @if( old('division_name') == $division->id ) selected @endif>{{ $division->name }}</option>
                                            @endforeach
                                        </select>
                                        @if ($errors->has('name'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="Enter District Name" required>
                                        @if ($errors->has('name'))
                                            <span class="text-danger">{{ $errors->first('name') }}</span>
                                        @endif
                                    </div>
