...
@section('title', 'ICSB Eligibility')
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-10 m-auto">
                                <form action="{{ url('/eligibility-create') }}" method="POST" class="form-horizontal"
                                    enctype="multipart/form-data" id="about_form">
                                    @csrf
                                    <div class="form-group row">
                                        <label class="col-sm-3" for="eligibility">Eligibility<span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                            <textarea type="text" class="ckeditor form-control" id="eligibility" placeholder="Write Your Post" name="eligibility"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 offset-md-3">
                                            <input type="file" name="eligibimage" id="eligibimage" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                        ...
                        <div class="table table-responsive">
                            <table id="table" class="about_table">
                                ...
                                <tr>
                                    ...
                                    <td id="titleVal">{!! $d->eligibility !!}</td>
                                    <td>
                                        <img src="{{ asset($d->eligibimage) }}" alt="" title="" height="100" width="100">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#about_form").submit(function(e) {
                // alert("yes");
                e.preventDefault()
                var data1 = CKEDITOR.instances.eligibility.getData();
                for ( instance in CKEDITOR.instances ) {
                    CKEDITOR.instances[instance].updateElement();
                }
                var formData = new FormData(this);
                length_array = [data1.length, $('#eligibimage').get(0).files.length]
                    count = 0
                    ...
                    success: function(response) {
                        ...
                        $.each(response, function(key, value) {
                            ...
                            student += '<td>' +
                                value.eligibility + '</td>';

                            student += '<td><img src="'+value.eligibimage+'" alt="" title="" height = "100" width="100">'
                                '</td>';

                            // student += '<td>' +
                            //     value.eligibimage + '</td>';
                        ...
                        table_head = '<th>SL</th><th>Eligibility</th><th>Image</th><th>Action</th>'
