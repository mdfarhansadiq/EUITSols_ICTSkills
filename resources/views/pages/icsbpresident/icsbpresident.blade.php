                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-10 m-auto">
                                <form action="{{ url('/icsb-president-create') }}" method="POST" class="form-horizontal"
                                    enctype="multipart/form-data" id="about_form">
                                    @csrf
                                    <div class="form-group row">
                                        <label class="col-sm-3" for="name">Name<span
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-3" for="presidescription">Description<span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                            <textarea type="text" class="ckeditor form-control" id="presidescription" placeholder="Write Your Post" name="presidescription"
                        ...
                        <div class="table table-responsive">
                            <table id="table" class="about_table">
                                ...
                                <tr>
                                    ...
                                    <td id="titleVal">{{ $d->name }}</td>

                                    <td>{!! $d->presidescription !!}</td>
                                    <td>
                                        <img src="{{ asset($d->image) }}" alt="" title="">
                                    </td>
...
<script type="text/javascript">
        $(document).ready(function() {
            $("#about_form").submit(function(e) {
                e.preventDefault()
                var data1 = CKEDITOR.instances.presidescription.getData();
                ...
                length_array = [formData.get('name').length, data1.length, $('#image').get(0).files.length]
                    count = 0
                    ...
                    success: function(response) {
                        ...
                        $.each(response, function(key, value) {
                            ...
                            student += '<td>' +
                                value.presidescription + '</td>';

                            student += '<td><img src="'+value.image+'" alt="" title="" height = "200" width="200">'
                                '</td>';
